...
export class FormCitasComponent implements OnInit {
  ...
  constructor(private citaService:CitaService,private detalleCitaService:DetalleCitaService,
  ...
  ngOnInit(): void {
          ...
          if(this.idCitaActualizar!==null){
              this.citaService.getCitaById(this.idCitaActualizar).subscribe((cita:any)=>{
        ...
        this.horas=['09:00-09:30','10:00-10:30','11:00-11:30','12:00-12:30','13:00-13:30'
        ,'14:00-14:30','15:00-15:30','16:00-16:30','17:00-17:30','18:00-18:30','19:00-19:30'
       ,'20:00-20:30','21:00-21:30']
  }

  get FechaNovalido(){
    return this.formularioCitas.get('Fecha')?.invalid && this.formularioCitas.get('Fecha')?.touched
     }

     get HoraNovalido(){
      return this.formularioCitas.get('Hora')?.invalid && this.formularioCitas.get('Hora')?.touched
       }
  ...
  if (result.isConfirmed) {
    ...
    formData.append("Hora", this.formularioCitas.value.Hora);
